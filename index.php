    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="index.html">Jérémie KASPERSKI</a></h1>
                <div class="social-links mt-3 text-center">
                    <!--<a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
          <a href="#" class="facebook"><i class="bx bxl-facebook"></i></a>-->
                    <a href="http://jkasperski.free.fr" class="instagram"><i class="bi bi-archive"></i></a>
                    <a href="https://github.com/codeuronline" class="google-plus"><i class="bi bi-github"></i></a>
                    <a href="https://www.linkedin.com/in/j%C3%A9r%C3%A9mie-kasperski-5b07a422a/" class="linkedin"><i
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="#about" class="nav-link scrollto"><i class="bx bx-user"></i> <span>A propos</span></a>
                    </li>
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>A propos</h2>
                    <p>Développeur Web et Web Mobile. Professionnel doté d'un grand
                        sens de l'organisation et d'une solide connaissance dans le domaine de l'Informatique, je
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Anniversaire:</strong> <span>5 Juin
                                            1976
                                        </span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Site Web:</strong>
                                        <span><a href="https://jkasperski.free.fr">jkasperski.free.fr</a></span>
                                    </li>
                                    <li><i class=" bi bi-chevron-right"></i> <strong>Téléphone:</strong> <span>+33 6 84
                                            45
                                            22 </span>
                                    </li>
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Niveau d'Etude:</strong>
                                        <span>Master</span>
                                    </li>
            ...
            <div class="container">
                ...
                <div class="row skills-content">
                    ...
                    <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="progress">
                            <span class="skill">Suite Office</span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0"
                                    aria-valuemax="100"></div>
                            </div>
                        ...
                        <div class="progress">
                            <span class="skill">Suite Adobe</span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0"
                                    aria-valuemax="100"></div>
                            </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Adresse:</h4>
                                <p>1, rue d'Alexandry 73000 Chambéry </p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>jkasperski@free.fr</p>
                            </div>
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2793.4139154388613!2d5.928083615769218!3d45.56211433492531!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478ba8e2f1210be9%3A0x521065b7de201f09!2s1%20Rue%20d&#39;Alexandry%2C%2073000%20Chamb%C3%A9ry!5e0!3m2!1sfr!2sfr!4v1649688234426!5m2!1sfr!2sfr"
